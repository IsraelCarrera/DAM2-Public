...
public class Configuration {
    ...
    void cargar() {
        ...
        try {
            ...
            Yaml yaml = new Yaml();
            Iterable<Object> it = yaml.loadAll(this.getClass().getClassLoader().getResourceAsStream("settings.yaml"));
            ...
            this.passKeyStore = m.get(Constantes.PASSKEYSTORE);
            this.nombreKeyStore = m.get(Constantes.NOMBREKEYSTORE);
