...
public class CambiarPartidos implements Initializable {
    ...
    private void borrarPartido() {
        if (lvPartidos.getSelectionModel().getSelectedItem() != null) {
            Single<Either<String, Partido>> singlePartido = Single.fromCallable(() -> sp.deletePartido(lvPartidos.getSelectionModel().getSelectedItem().getIdJornada(),
    ...
    private void updatePartido() {
        try {
            ...
            if (lvPartidos.getSelectionModel().getSelectedItem() != null) {
                Single<Either<String, Partido>> singlePartido = Single.fromCallable(() -> sp.updatePartido(lvPartidos.getSelectionModel().getSelectedItem(),
