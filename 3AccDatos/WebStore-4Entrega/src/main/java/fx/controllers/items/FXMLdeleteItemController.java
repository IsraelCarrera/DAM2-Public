...
public class FXMLdeleteItemController implements Initializable {
    ...
    private void deleteItem() {
        ...
        if (itemsBox.getSelectionModel().getSelectedItem() != null) {
            ...
            List<Purchase> purchaseList = ps.getPurchaseByIdItem(itemsBox.getSelectionModel().getSelectedItem().getIdItem());
            if (!purchaseList.isEmpty()) {
                ...
                if (alerta.getResult() == ButtonType.OK) {
                    ...
                    if (rs.searchByItem(itemsBox.getSelectionModel().getSelectedItem().getIdItem()).isEmpty()) {
