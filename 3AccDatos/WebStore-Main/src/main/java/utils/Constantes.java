...
public class Constantes {
    ...
    public static final String MORE_INFO_REVIEW = "More Info Review";
    public static final String THERE_IS_NOT_ENOUGH_RATE = "There is not enough rate.";
    public static final String DATE_ASCENDANT = "date ascendant";
    public static final String DATE_DESCENDENT = "date descendent";
    public static final String RATING_ASCENDANT = "rating ascendant";
    public static final String RATING_DESCENDENT = "rating descendent";
    public static final String NUMBER_OF_PURCHASES_IN = "Number of purchases in ";
    ...
    public static final String YOU_HAVE_NOT_SELECTED_ANYTHING = "You have not selected anything.";
}
